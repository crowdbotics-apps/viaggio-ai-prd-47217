"""
Django settings for viaggio_ai_prd_47217 project.
...
ROOT_URLCONF = 'viaggio_ai_prd_47217.urls'
...
WSGI_APPLICATION = 'viaggio_ai_prd_47217.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "viaggio_ai_prd_47217 API",
    "DESCRIPTION": "API documentation for viaggio_ai_prd_47217 App",
    "VERSION": "v1",
}
